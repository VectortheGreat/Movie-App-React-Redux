...
const Detail = ({ product }) => {
    ...
    const watchTrailerUrl = () => {
        // window.location.href = pr.trailerUrl
            ...
            <div className="container mx-auto my-3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col items-center">
                        ...
                        />
                        <div className="mt-3">
                            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full" onClick={watchTrailerUrl}>
                                Watch Trailer
                            </button>
                        </div>
                    </div>
                    <div className="px-5 py-3 border border-black rounded-md my-3">
                        ...
                        <div className="my-2">
                            <span className="font-semibold">Description:</span> {pr.description}
                        </div>
                        <div className="my-2">
                            <span className="font-semibold">IMDb Rating:</span> {pr.imdbRating}
                        </div>
                        <div className="my-2">
                ...
                <div className="px-5 py-3 border border-black rounded-md my-3">
                    ...
                    <p className="my-2">
                        Buraya IMDb tarzında bir film incelemesi metni ekleyebilirsiniz. Film hakkında detaylı bilgiler, değerlendirmeler ve görüşler burada yer alabilir.
                    </p>
                </div>
            </div>
        </>
